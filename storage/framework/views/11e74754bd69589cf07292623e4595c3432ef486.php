...
dir="<?php echo e(LaravelLocalization::getCurrentLocaleDirection()); ?>">
	...
	<body class="app sidebar-mini <?php echo $themeClass; ?> <?php echo e(LaravelLocalization::getCurrentLocaleDirection()); ?>">
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(\App\Services\HelperService::checkOnboardingProAccess()): ?>
                <?php echo $__env->make('components.onboarding-integration', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        <?php endif; ?>
...
<?php /**PATH /home/hootgpt-app/htdocs/app.hootgpt.com/resources/views/default/layouts/app.blade.php ENDPATH**/ ?>