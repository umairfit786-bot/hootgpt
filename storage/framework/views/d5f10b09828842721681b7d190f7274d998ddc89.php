                ...
                <?php if($item['has_access']): ?>
                    <li class="slide">
                        <?php if(!empty($item['children'])): ?>
                            <a class="side-menu__item" data-toggle="slide" href="<?php echo e($item['url'] ?? '#'); ?>" id="<?php echo e($item['key'] ?? ''); ?>">
                        ...
                        <?php else: ?>
                            <a class="side-menu__item" href="<?php echo e($item['route'] ? route($item['route']) : $item['url']); ?>" id="<?php echo e($item['key'] ?? ''); ?>">
                                <span class="side-menu__icon <?php echo e($item['icon']); ?>"></span>                        
                                <span class="side-menu__label"><?php echo e(__($item['label'])); ?></span>
                                <?php if(!empty($item['badge_text'])): ?>
                                    <span class="badge badge-<?php echo e($item['badge_type'] ?? 'primary'); ?>"><?php echo e($item['badge_text']); ?></span>
...
<?php /**PATH /home/hootgpt-app/htdocs/app.hootgpt.com/resources/views/default/layouts/dashboard/nav-aside.blade.php ENDPATH**/ ?>