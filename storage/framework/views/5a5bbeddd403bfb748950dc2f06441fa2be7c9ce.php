	...
	<div class="row">	
		<div class="col-lg col-md-6 col-sm-12 mt-auto mb-auto">                        
			<div class="title text-center dashboard-title">
				...
				<h3 class="fs-24 mb-3 super-strong"><?php echo config('payment.default_system_currency_symbol'); ?> <?php echo e(number_format((float)$total['total_income'][0]['data'],2)); ?></h3>  
		...
		<div class="col-lg col-md-6 col-sm-12 mt-auto mb-auto">                        
			<div class="title text-center dashboard-title">
				...
				<h3 class="fs-24 mb-3 super-strong">$<?php echo e(number_format((float)$total['total_spending'], 3)); ?></h3>     
		...
		<div class="col-lg col-md-2 col-sm-12">
			<div class="card  ">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<p class=" mb-2 fs-12 font-weight-semibold text-muted"><i class="   fa-solid fa-badge-percent mr-2 text-muted"></i><?php echo e(__('Total Referral Payouts')); ?></p>
				...
				<div class="card-body pt-2 height-400">
					...
					<div class="row">
						...
						<?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-sm-12">					
								<div class="card" onclick="window.location.href='<?php echo e(theme_url('app/admin/finance/transactions')); ?>'">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hootgpt-app/htdocs/app.hootgpt.com/resources/views/default/admin/finance/dashboard/finance_dashboard_index.blade.php ENDPATH**/ ?>