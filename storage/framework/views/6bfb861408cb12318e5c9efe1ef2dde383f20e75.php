    ...
    <?php if($extension->maintenance_feature): ?>                    
        <div class="container">
            ...
            <footer class="text-center  align-items-center">
                <p class="text-muted"><?php echo e(__($extension->maintenance_message)); ?> </p>
            </footer>
        </div>
    <?php else: ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hootgpt-app/htdocs/app.hootgpt.com/resources/views/default/auth/register.blade.php ENDPATH**/ ?>