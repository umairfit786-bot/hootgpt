...
class DavinciConfigController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.davinci.configuration.index', compact('languages', 'voiceover_languages', 'voices', 'filters', 'models', 'vendors', 'all_models', 'images'));
    }
    ...
    public function storeImageCredits(Request $request)
    {
        ...
        $prices->update([
            ...
            'gpt_image_1' => request('gpt_image_1'),
            'gpt_image_1_mini' => request('gpt_image_1_mini'),
            'gpt_image_1_5' => request('gpt_image_1_5'),
            'google_nano_banana' => request('google_nano_banana'),
            'google_nano_banana_pro' => request('google_nano_banana_pro'),
        ]);
