...
class FinanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.finance.dashboard.finance_dashboard_index', compact('percentage', 'chart_data', 'total', 'total_monthly', 'transactions', 'prepaid', 'subscription', 'approvals', 'latest_transactions'));
    }
    ...
    public function listTransactions(Request $request)
    {
                ...
                ->addColumn('custom-gateway', function ($row) {
                    switch ($row['gateway']) {
                        ...
                        case 'TwoCheckout':
                            ...
                            break;
                        case 'Wallet':
                            $custom_gateway = '<div class="overflow-hidden"><img alt="Wallet Gateway" class="w-30" src="' . theme_url('img/payments/wallet.avif') . '" title="Wallet Balance"></div>';
                            break;
                        case 'Awdpay':
                            $custom_gateway = '<div class="overflow-hidden"><img alt="Awdpay Gateway" class="w-20" src="' . theme_url('img/payments/awdpay.png') . '"></div>';
                            break;
                        case 'Manual':
        ...
        return view('admin.finance.transactions.finance_transaction_index');
    }
    ...
    public function listSubscriptions(Request $request)
    {
        ...
        return view('admin.finance.transactions.finance_transaction_subscriptions');
    }
    ...
    public function show(Payment $id)
    {
        ...
        return view('admin.finance.transactions.finance_transaction_show', compact('id', 'user'));
    }
    ...
    public function edit(Payment $id)
    {
        ...
        return view('admin.finance.transactions.finance_transaction_edit', compact('id', 'user'));
    }
    ...
    public function update(Payment $id)
    {
        ...
        if ($id->status == 'completed') {
            ...
            if ($id->frequency != 'prepaid') {
                ...
                $user->tokens = $id->tokens;
                $user->characters = $id->characters;
                $user->minutes = $id->minutes;
                $user->images = $id->images;
                ...
                $user->tokens_prepaid = $user->tokens_prepaid + $id->tokens;
                $user->images_prepaid = $user->images_prepaid + $id->images;
                $user->characters_prepaid = $user->characters_prepaid + $id->characters;
                $user->minutes_prepaid = $user->minutes_prepaid + $id->minutes;
                $user->voice_clones_prepaid = $user->voice_clones_prepaid + $id->voice_clones;
                $user->save();
            }
    ...
    public function monthlyReport(Request $request)
    {
        ...
        return view('admin.finance.dashboard.finance_dashboard_monthly', compact('monthly_report'));
    }
    ...
    public function yearlyReport()
    {
        ...
        return view('admin.finance.dashboard.finance_dashboard_yearly', compact('monthly_report'));
    }
