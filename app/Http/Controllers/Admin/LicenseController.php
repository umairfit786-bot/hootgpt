...
class LicenseController extends Controller
{
	...
	public function __construct(){ 
        ...
        try {
            ...
            $this->license = Setting::where('name', 'license')->exists() ? Setting::where('name', 'license')->value('value') : null;
        } catch (Exception $e) {
            $this->license = null;
        }
