...
class FinancePromocodeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.finance.promocodes.finance_promocode_index');
    }
    ...
    {   
        return view('admin.finance.promocodes.finance_promocode_create');
    }
    ...
    {   
        ...
        return view('admin.finance.promocodes.finance_promocode_show', compact('id', 'data'));
    }
    ...
    public function edit(Promocode $id)
    {
        ...
        return view('admin.finance.promocodes.finance_promocode_edit', compact('id', 'data'));
    }
    ...
    {   
        ...
        return view('admin.finance.promocodes.finance_promocode_delete', compact('promocode'));  
    }
}
