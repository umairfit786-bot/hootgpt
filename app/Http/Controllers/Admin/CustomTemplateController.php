        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('actions', function($row){
                    $actionBtn = '<div>      
                                    <a href="'. route("admin.davinci.custom.show", $row["id"] ). '"><i class="fa fa-edit table-action-buttons view-action-button" title="'. __('Edit Template') .'"></i></a>      
                                    <a class="changeButton" id="' . $row["id"] . '"  type="' . $row['type'] . '" href="#"><i class="fa-solid fa-square-parking table-action-buttons request-action-button" title="'. __('Set Template Package') .'"></i></a>
                                    <a class="newButton" id="' . $row["id"] . '"  type="' . $row['type'] . '" href="#"><i class="fa-solid fa-sparkles table-action-buttons edit-action-button" title="'. __('Set as New Template') .'"></i></a>
            ...
            return Datatables::of($data)
                ...
                ->addColumn('actions', function($row){
                    $actionBtn = '<div>      
                                    ...
                                    <a class="editDescription" id="' . $row["id"] . '" href="#"><i class="fa-solid fa-money-check-pen table-action-buttons view-action-button" title="'. __('Update Category Description') .'"></i></a>          
                ...
                ->addColumn('custom-description', function($row){
                    $user = '<span>'. ucfirst(__($row['description'])) .'</span>';
                    return $user;
                }) 
                ...
                ->rawColumns(['actions', 'updated-on', 'custom-name', 'custom-description', 'custom-type'])
                ->make(true);
