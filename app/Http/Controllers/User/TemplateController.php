	...
	*/
	public function process(Request $request) 
    {
        ...
        if($realtime == 'on') {
         ...
         # Start OpenAI task
         if (in_array($model, ['gpt-5.2-pro', 'gpt-5.2', 'gpt-5.1', 'gpt-5', 'gpt-5-mini', 'gpt-5-nano', 'gpt-5-chat-latest', 'gpt-3.5-turbo-0125', 'gpt-4', 'gpt-4o', 'gpt-4o-mini', 'gpt-4.5-preview', 'o1', 'o1-mini', 'o3-mini', 'gpt-4-0125-preview', 'o3', 'o4-mini', 'gpt-4.1', 'gpt-4.1-mini', 'gpt-4.1-nano', 'gpt-4o-search-preview', 'gpt-4o-mini-search-preview'])) {
        ...
        if (in_array($model, ['claude-opus-4-6', 'claude-sonnet-4-6', 'claude-sonnet-4-5', 'claude-haiku-4-5', 'claude-3-7-sonnet-20250219', 'claude-3-opus-20240229', 'claude-3-5-sonnet-20241022', 'claude-3-5-haiku-20241022', 'claude-opus-4-20250514', 'claude-sonnet-4-20250514', 'claude-opus-4-1-20250805', 'claude-opus-4-5-20251101'])) {
         ...
         # Start Anthropic task         
         if (in_array($model, ['gemini-2.5-flash', 'gemini-2.5-pro', 'gemini-2.5-flash-lite', 'gemini-3-pro-preview', 'gemini-3-flash-preview'])) {
        ...
        # Start xAI task
       if (in_array($model, ['grok-2-1212', 'grok-2-vision-1212', 'grok-3-latest', 'grok-3-fast-latest', 'grok-3-mini-latest', 'grok-3-mini-fast-latest', 'grok-4-latest', 'grok-4-1-fast-non-reasoning'])) {
        ...
        # Start Nova task         
        if ($model == 'us.amazon.nova-micro-v1:0' || $model == 'us.amazon.nova-lite-v1:0' || $model == 'us.amazon.nova-pro-v1:0' || $model == 'us.amazon.nova-2-pro-v1:0' || $model == 'us.amazon.nova-2-lite-v1:0' || $model == 'us.amazon.nova-2-omni-v1:0') {    
    ...
    private function streamOpenai($prompt, $content_id, $max_results, $max_words, $temperature, $openai_api)
    {
        return response()->stream(function () use($prompt, $content_id, $max_results, $max_words, $temperature, $openai_api) {
            ...
            try {
                ...
                if (in_array($model, ['o1', 'o1-mini', 'o3-mini', 'o3', 'o4-mini', 'gpt-5', 'gpt-5-mini', 'gpt-5-nano', 'gpt-5-chat-latest', 'gpt-5.1', 'gpt-5.2', 'gpt-5.2-pro'])) {
        ...
        return response()->stream(function () use($prompt, $content_id, $max_results, $max_words, $temperature, $gemini_api) {
            ...
            try {
                ...
                if (json_last_error() !== JSON_ERROR_NONE || !is_array($results)) {
                    ...
                    echo 'data: Gemini API Error: <span class="font-weight-bold">Invalid response format</span>';
                    echo "\n\n";
                    echo 'data: [DONE]';
                    echo "\n\n";
                    ob_flush();
