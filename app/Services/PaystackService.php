...
class PaystackService 
{
    ...
    {   
        ...
        try {
            ...
            toastr()->error(__('Paystack authentication error, verify your paystack settings first1'));
            return redirect()->back();
        }
    ...
    public function handleApproval(Request $request)
    {
        if (session()->has('order_reference')) {
            ...
            if ($reference->data->status == 'success') {
                ...
                $payment = HelperService::registerPayment($type, $plan->id, $approvalID, $amount, 'Paystack', 'completed', $billing_info);
