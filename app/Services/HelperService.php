...
class HelperService
{
    ...
    public static function checkMediaCredits($model)
    {
        ...
        if ($model == 'heygen_image' || $model == 'heygen_video') {
            $settings = \App\Models\ExtensionSetting::first();
            if ($model == 'heygen_image') {
                $cost = $settings->heygen_image_credit_cost ?? 1;
            } else {
                $cost = $settings->heygen_video_credit_cost ?? 1;
            }
        }
     ...
     *
     */
    public static function registerPayment($type, $id, $order, $price, $gateway, $status, $request = null)
    {
        if ($type == 'prepaid') {
        ...
        $record_payment->billing_first_name = $request->name ?? null;
        $record_payment->billing_last_name = $request->lastname ?? null;
        $record_payment->billing_email = $request->email ?? null;
        $record_payment->billing_phone = $request->phone_number ?? null;
        $record_payment->billing_city = $request->city ?? null;
        $record_payment->billing_postal_code = $request->postal_code ?? null;
        $record_payment->billing_country = $request->country ?? null;
        $record_payment->billing_vat_number = $request->vat ?? null;
        $record_payment->billing_address = $request->address ?? null;
        $record_payment->save();
    ...
    public static function checkFeatureAccess($name)
    {
        switch ($name) {
            case 'ai_writer':
                return self::checkAIWriterAccess();
                break;
            case 'ai_article_wizard':
                return self::checkAIArticleWizardAccess();
                break;
            case 'smart_editor':
                return self::checkSmartEditorAccess();
                break;
            case 'ai_images':
                return self::checkAIImagesAccess();
                break;
            case 'ai_rewriter':
                return self::checkAIRewriterAccess();
                break;
            case 'ai_voiceover':
                return self::checkVoiceoverAccess();
                break;
            case 'voice_cloning':
                return self::checkVoiceCloningAccess();
                break;
            case 'sound_studio':
                return self::checkSoundStudioAccess();
                break;
            case 'ai_speech_to_text':
                return self::checkSpeechToTextAccess();
                break;
            case 'ai_chat':
                return self::checkChatAccess();
                break;
            case 'ai_realtime_chat':
                return self::checkRealtimeChatAccess();
                break;
            case 'ai_vision':
                return self::checkVisionAccess();
                break;
            case 'ai_file_chat':
                return self::checkFileChatAccess();
                break;
            case 'ai_web_chat':
                return self::checkWebChatAccess();
                break;
            case 'ai_youtube':
                return self::checkYoutubeAccess();
                break;
            case 'ai_rss':
                return self::checkRSSAccess();
                break;
            case 'ai_chat_image':
                return self::checkChatImageAccess();
                break;
            case 'ai_code':
                return self::checkCodeAccess();
                break;
            case 'brand_voice':
                return self::checkBrandVoiceAccess();
                break;
            case 'ai_video_image':
                return self::checkVideoImageAccess();
                break;
            case 'ai_video_text':
                return self::checkVideoTextAccess();
                break;
            case 'ai_video_video':
                return self::checkVideoVideoAccess();
                break;
            case 'ai_photo_studio':
                return self::checkPhotoStudioAccess();
                break;
            case 'ai_product_photo':
                return self::checkProductPhotoAccess();
                break;
            case 'faceswap':
                return self::checkFaceswapAccess();
                break;
            case 'ai_social_media':
                return self::checkSocialMediaAccess();
                break;
            case 'ai_music':
                return self::checkMusicAccess();
                break;
            case 'ai_textract':
                return self::checkTextractAccess();
                break;
            case 'integration':
                return self::checkIntegrationAccess();
                break;
            case 'ai_plagiarism_checker':
                return self::checkPlagiarismAccess();
                break;
            case 'ai_content_detector':
                return self::checkContentDetectorAccess();
                break;
            case 'ai_avatar':
                return self::checkAvatarAccess();
                break;
            case 'voice_isolator':
                return self::checkVoiceIsolatorAccess();
                break;
            case 'external_chatbot':
                return self::checkExternalChatbotAccess();
                break;
            case 'seo_tool':
                return self::checkSEOToolAccess();
                break;
            case 'team_members':
                return self::checkTeamMemberAccess();
                break;
            ...
            case 'payment_settings':
                return self::checkSaaSAccess();
                break;
            case 'affiliate_program':
                return self::checkReferralAccess();
                break;
            case 'menu_builder':
                return self::checkMenuAccess();
                break;
            case 'ai_speech_to_text_pro':
                return self::checkSpeechProAccess();
                break;
            case 'speechify_clone':
                return self::checkSpeechifyCloneAccess();
                break;
            case 'live_announcements':
                return self::checkLiveAnnouncementsAccess();
                break;
            case 'onboarding_pro':
                return self::checkOnboardingProAccess();
                break;
            case 'chat_pro':
                return self::checkChatProAccess();
                break;
            case 'voice_chatbot':
                return self::checkVoiceChatbotAccess();
                break;
            case 'human_agent':
                return self::checkHumanAgentAccess();
                break;
            default:
                return true;
                break;
    ...
    // EXTERNAL CHATBOT ANALYTICS FEATURE
    // ===================================================================================
    public static function checkExternalChatbotAnalyticsAccess()
    {

        if (self::extensionExternalChatbotAnalytics()) {
            return self::checkExternalChatbotAnalyticsFeature();
        } else {
            return false;
        }
    }
    ...
    // ONBOARDING PRO FEATURE
    // ===================================================================================
    public static function checkOnboardingProAccess()
    {

        if (self::extensionOnboardingPro()) {
            return self::extensionOnboardingProFeature();
        } else {
            return false;
        }
    ...
    // LIVE ANNOUNCEMENTS FEATURE
    // ===================================================================================
    public static function checkLiveAnnouncementsAccess()
    {

        return self::extensionLiveAnnouncement();
    ...
    // ===================================================================================
    public static function checkTelegramBotAccess()
    {

        if (self::extensionTelegramBot()) {
            return self::extensionTelegramBotFeature();
        } else {
            return false;
        }
    ...
    // ===================================================================================
    public static function checkWhatsappBotAccess()
    {

        if (self::extensionWhatsappBot()) {
            return self::extensionWhatsappBotFeature();
        } else {
            return false;
        }
    ...
    // ===================================================================================
    public static function checkVoiceChatbotAccess()
    {
        if (self::extensionVoiceChatbot()) {
            return self::checkVoiceChatbotFeature();
        } else {
            return false;
        }
    }
    ...
    // HUMAN AGENT FEATURE
    // ===================================================================================
    public static function checkHumanAgentAccess()
    {
        if (self::extensionHumanAgent()) {
            return self::checkHumanAgentFeature();
    ...
    // CHAT PRO FEATURE
    // ===================================================================================
    public static function checkChatProAccess()
    {
        if (self::extensionChatPro()) {
            return self::checkChatProFeature();
        } else {
            return false;
        }
    }
    ...
    public static function extensionOnboardingProFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->onboarding_pro_feature)) {

            if ($settings->onboarding_pro_feature) {
                return true;
            } else {
                return false;
            }
    ...
    public static function checkSpeechifyVoiceCloneFeature()
    {
        ...
        if (isset($settings->speechify_clone_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->speechify_voice_clone_feature)) {
                    return $plan->speechify_voice_clone_feature;
                } else {
                    return false;
                }
            } else {
    ...
    // LIVE ANNOUNCEMENT EXTENSION
    // ===================================================================================
    public static function extensionLiveAnnouncement()
    {
        $extension = Extension::where('slug', 'live-announcement')->first();
    ...
    // ===================================================================================
    public static function extensionTelegramBot()
    {
        $extension = Extension::where('slug', 'telegram-bot')->first();
    ...
    public static function extensionTelegramBotFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->telegram_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->telegram_feature)) {
                    return $plan->telegram_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->telegram_feature) {
                    if ($settings->telegram_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    // ===================================================================================
    public static function extensionWhatsappBot()
    {
        $extension = Extension::where('slug', 'whatsapp-bot')->first();
    ...
    public static function extensionWhatsappBotFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->whatsapp_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->whatsapp_feature)) {
                    return $plan->whatsapp_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->whatsapp_feature) {
                    if ($settings->whatsapp_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    // LEMONFOX TEXT TO SPEECH EXTENSION
    // ===================================================================================
    public static function extensionLemonfoxTextToSpeech()
    {
        $extension = Extension::where('slug', 'lemonfox-text')->first();
    ...
    // EXTERNAL CHATBOT ANALYTICS EXTENSION
    // ===================================================================================
    public static function extensionExternalChatbotAnalytics()
    {
        $extension = Extension::where('slug', 'external-analytics')->first();
    ...
    public static function checkExternalChatbotAnalyticsFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->chatbot_external_analytics_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->chatbot_external_analytics_feature)) {
                    return $plan->chatbot_external_analytics_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->chatbot_external_analytics_feature) {
                    if ($settings->chatbot_external_analytics_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    // ===================================================================================
    public static function extensionNanoBanana()
    {
        $extension = Extension::where('slug', 'nano-banana')->first();
    ...
    // AWDPAY EXTENSION
    // ===================================================================================
    public static function extensionAwdpay()
    {
        $extension = Extension::where('slug', 'awdpay')->first();
    ...
    // EXTERNAL VOICE CHATBOT EXTENSION
    // ===================================================================================
    public static function extensionVoiceChatbot()
    {
        $extension = Extension::where('slug', 'voice-chatbot')->first();
    ...
    public static function checkVoiceChatbotFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->chatbot_external_voice_bot_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->chatbot_external_voice_bot_feature)) {
                    return $plan->chatbot_external_voice_bot_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->chatbot_external_voice_bot_feature) {
                    if ($settings->chatbot_external_voice_bot_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    // EXTERNAL CHATBOT KNOWLEDGE BASE EXTENSION
    // ===================================================================================
    public static function extensionExternalChatbotKnowledgeBase()
    {
        $extension = Extension::where('slug', 'knowledge-base')->first();
    ...
    //  AI CHAT PRO EXTENSION
    // ===================================================================================
    public static function extensionChatPro()
    {
        $extension = Extension::where('slug', 'chat-pro')->first();
    ...
    public static function checkChatProFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->chat_pro_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->chat_pro_feature)) {
                    return $plan->chat_pro_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->chat_pro_feature) {
                    if ($settings->chat_pro_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    // ===================================================================================
    public static function extensionHumanAgent()
    {
        $extension = Extension::where('slug', 'human-agent')->first();
    ...
    public static function checkHumanAgentFeature()
    {
        $settings = ExtensionSetting::first();

        if (isset($settings->chatbot_external_human_feature)) {
            if (!is_null(auth()->user()->plan_id)) {
                $plan = SubscriptionPlan::where('id', auth()->user()->plan_id)->first();
                if (!is_null($plan->chatbot_external_human_feature)) {
                    return $plan->chatbot_external_human_feature;
                } else {
                    return false;
                }
            } else {
                if ($settings->chatbot_external_human_feature) {
                    if ($settings->chatbot_external_human_free_tier) {
                        return true;
                    } else {
                        return false;
                    }
