...
class BraintreeService 
{
    ...
    {   
        ...
        try {
            ...
            session()->put('billing_info', $request);
    ...
    {        
        ...
        if ($result->success) {
            ...
            $payment = HelperService::registerPayment($type, $plan->id, $result->transaction->id, $result->transaction->amount, 'Braintree', 'completed', $billing_info);
