...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('subscription_plans', function (Blueprint $table) {
            ...
            $table->boolean('telegram_feature')->default(false);
            $table->integer('telegram_total_bots')->default(1)->nullable();
            $table->boolean('whatsapp_feature')->default(false);
            $table->integer('whatsapp_total_bots')->default(1)->nullable();
            $table->boolean('speechify_voice_clone_feature')->nullable()->default(0);
            $table->integer('speechify_voice_clone_number')->nullable()->default(0);
            $table->boolean('chatbot_external_analytics_feature')->nullable()->default(0);
            $table->boolean('chatbot_external_human_feature')->nullable()->default(0);
            $table->boolean('chatbot_external_voice_bot_feature')->nullable()->default(0);
            $table->integer('chatbot_external_voice_bot_quantity')->nullable()->default(0);
            $table->text('template_categories')->nullable();
            $table->text('chat_categories')->nullable();
            $table->boolean('chat_pro_feature')->default(false)->nullable();
            $table->timestamps();
        });
    }
