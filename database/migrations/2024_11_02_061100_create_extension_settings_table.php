...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('extension_settings', function (Blueprint $table) {
            ...
            $table->integer('speechify_clone_limit')->nullable()->default(0);
            $table->boolean('onboarding_pro_feature')->default(false);
            $table->boolean('onboarding_auto_start')->default(false);
            $table->boolean('telegram_feature')->default(false);
            $table->boolean('telegram_free_tier')->default(false);
            $table->integer('telegram_total_bots')->default(1)->nullable();
            $table->boolean('whatsapp_feature')->default(false);
            $table->boolean('whatsapp_free_tier')->default(false);
            $table->integer('whatsapp_total_bots')->default(1)->nullable();
            $table->boolean('lemonfox_tts_feature')->default(false);
            $table->string('lemonfox_tts_api')->nullable();
            $table->boolean('chatbot_external_analytics_feature')->default(false);
            $table->boolean('chatbot_external_analytics_free_tier')->default(false);
            $table->boolean('chatbot_external_human_feature')->default(false);
            $table->boolean('chatbot_external_human_free_tier')->default(false);
            $table->boolean('chatbot_external_voice_bot_feature')->default(false);
            $table->boolean('chatbot_external_voice_bot_free_tier')->default(false);
            $table->integer('chatbot_external_voice_bot_quantity')->default(1);
            $table->string('chatbot_external_voice_bot_api')->nullable();
            $table->string('google_nano_banana_api')->nullable();
            $table->string('video_text_openai_api')->nullable();
            $table->boolean('chatbot_external_personal_api')->default(false);
            $table->boolean('chat_pro_feature')->default(false);
            $table->boolean('chat_pro_free_tier')->default(false);
            $table->timestamps();
        });
    }
