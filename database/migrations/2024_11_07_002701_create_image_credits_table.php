...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('image_credits', function (Blueprint $table) {
            ...
            $table->integer('sd_3_flash')->nullable()->default(3);
            ...
            $table->integer('gpt_image_1')->nullable()->default(1);
            $table->integer('google_nano_banana')->nullable()->default(1);
            $table->integer('openai_sora_2_pro_video')->nullable()->default(1);
            $table->integer('openai_sora_2_video')->nullable()->default(1);
            $table->integer('google_nano_banana_pro')->nullable()->default(1);
            $table->integer('gpt_image_1_mini')->nullable()->default(1);
            $table->integer('gpt_image_1_5')->nullable()->default(1);
