						...
						<div class="grid-image-wrapper">
							...
							<div class="grid-description">
								<span class="fs-9 text-primary">
									...
									@elseif ($image->vendor == 'google') {{ __('Google') }} 
									@endif
								</span>
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">		
								@foreach ($vendors as $vendor)
									@if (trim($vendor) == 'openai')
										...
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="gpt-image-1" name="{{ __('OpenAI GPT Image') }}" icon="<i class='fa-solid fa-droplet'></i>">
											<h6 class="dropdown-item-title fs-12">{{ __('OpenAI GPT Image') }} <span class="fs-9 text-muted">({{ $credits->gpt_image_1 }} @if ($credits->gpt_image_1 == 1) {{ __('credit') }}@else{{ __('credits') }}@endif)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="gpt-image-1-mini" name="{{ __('OpenAI GPT Image Mini') }}" icon="<i class='fa-solid fa-droplet'></i>">
											<h6 class="dropdown-item-title fs-12">{{ __('OpenAI GPT Image Mini') }} <span class="fs-9 text-muted">({{ $credits->gpt_image_1_mini }} @if ($credits->gpt_image_1_mini == 1) {{ __('credit') }}@else{{ __('credits') }}@endif)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="gpt-image-1.5" name="{{ __('OpenAI GPT Image 1.5') }}" icon="<i class='fa-solid fa-droplet'></i>">
											<h6 class="dropdown-item-title fs-12">{{ __('OpenAI GPT Image 1.5') }} <span class="fs-9 text-muted">({{ $credits->gpt_image_1_5 }} @if ($credits->gpt_image_1_5 == 1) {{ __('credit') }}@else{{ __('credits') }}@endif)</span></h6>										
										</a>
									@endif
								@endforeach								
								@foreach ($vendors as $vendor)
								...
								@if (App\Services\HelperService::extensionNanoBanana())
									@foreach ($vendors as $vendor)
										@if (trim($vendor) == 'google')																				
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="gemini-2.5-flash-image" name="{{ __('Nano Banana') }}" icon="<i class='   fa-solid fa-high-definition'></i>">						
												<h6 class="dropdown-item-title fs-12">{{ __('Nano Banana') }} <span class="fs-9 text-muted">({{ $credits->google_nano_banana }} @if ($credits->google_nano_banana == 1) {{ __('credit') }}@else{{ __('credits') }}@endif)</span></h6>										
											</a>	
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="gemini-3-pro-image-preview" name="{{ __('Nano Banana Pro') }}" icon="<i class='   fa-solid fa-high-definition'></i>">						
												<h6 class="dropdown-item-title fs-12">{{ __('Nano Banana Pro') }} <span class="fs-9 text-muted">({{ $credits->google_nano_banana_pro }} @if ($credits->google_nano_banana_pro == 1) {{ __('credit') }}@else{{ __('credits') }}@endif)</span></h6>										
											</a>									
										@endif
									@endforeach
								@endif
...
<script type="text/javascript">
	...
	function setResolution() {
		...
		if (active_model == 'dall-e-2') {	
			...
			vendor = 'openai';
			openaiReset();
		} else if (active_model == 'gpt-image-1' || active_model == 'gpt-image-1-mini' || active_model == 'gpt-image-1.5') {
			$('#resolution').append('<option value="1024x1024" selected>1024 x 1024px</option>');																												
			$('#resolution').append('<option value="1536x1024">1536 x 1024px</option>');																												
			$('#resolution').append('<option value="1024x1536">1024 x 1536px</option>');
			vendor = 'openai';
			openaiReset();
			...
			vendor = 'clipdrop';
			falaiReset();
		} else if (active_model == 'gemini-2.5-flash-image' || active_model == 'gemini-3-pro-image-preview') {
			$('#resolution').append("<option value='1024x1024' selected>1024 x 1024px</option>");
			$('#resolution').append("<option value='832x1248'>832 x 1248px</option>");
			$('#resolution').append("<option value='1248x832'>1248 x 832px</option>");
			$('#resolution').append("<option value='864x1184'>864 x 1184px</option>");
			$('#resolution').append("<option value='1184x864'>1184 x 864px</option>");
			$('#resolution').append("<option value='896x1152'>896 x 1152px</option>");
			$('#resolution').append("<option value='1152x896'>1152 x 896px</option>");
			$('#resolution').append("<option value='768x1344'>768 x 1344px</option>");
			$('#resolution').append("<option value='1344x768'>1344 x 768px</option>");
			$('#resolution').append("<option value='1536x672'>1536 x 672px</option>");
			vendor = 'google';
			falaiReset();
		}
	}
