	...
	<div class="row mt-24 justify-content-center">
		...
		<div class="col-lg-4 col-md-4 col-sm-12">
			<div class="card border-0">
				<div class="card-header pt-4 border-0">
					<p class="fs-11 text-muted mb-0 text-left"><i class="fa-solid fa-bolt-lightning mr-2 text-primary"></i>{{ __('Your Balance is') }} <span class="font-weight-semibold" id="balance-number">@if (auth()->user()->images == -1) {{ __('Unlimited') }} @else {{ number_format(auth()->user()->images + auth()->user()->images_prepaid) }}@endif {{ __('media credits') }}</span></p>
				</div>
						...
						<div class="photo-studio-tools mb-5">
							<div class="nav-item dropdown w-100">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">										
									...
									<a class="dropdown-item d-flex" href="#"  id="style" name="{{ __('Same Style Image') }}" icon="<i class='fa-solid fa-palette'></i>">
										<span class="dropdown-item-icon mr-3 ml-1 text-muted"><i class="fa-solid fa-palette"></i></span>
									...
									<a class="dropdown-item d-flex" href="#"  id="upscale_conservative" name="{{ __('Conservative Upscale') }}" icon="<i class='fa-solid fa-high-definition'></i>">
										<span class="dropdown-item-icon mr-3 ml-1 text-muted"><i class="fa-solid fa-high-definition"></i></span>
									...
									<a class="dropdown-item d-flex" href="#"  id="upscale_creative" name="{{ __('Creative Upscale') }}" icon="<i class='fa-solid fa-high-definition'></i>">
										<span class="dropdown-item-icon mr-3 ml-1 text-muted"><i class="fa-solid fa-high-definition"></i></span>
							...
							<div id="image-drop-box">
								...
								<div class="image-drop-area text-center mt-2 file-drop-border photo-studio-upload">
									...
									<div class="image-upload-icon">
										<i class="fa-solid fa-camera fs-28 text-muted"></i>
									</div>
		...
		<div class="col-lg-6 col-md-8 col-xm-12">
			<div id="photo-studio-placeholder" class="text-center">
				<img class="mb-4" src="{{ theme_url('img/svgs/gallery.svg') }}" alt="">
				<h6 class="text-muted">{{ __('Start generating your image') }}</h6>
			</div>
			<div id="photo-studio-result" class="hidden">
				<div class="card border-0">
					<div class="card-body p-6">
						<a href="" id="download" class="download-image text-center" download><i class="fa-solid fa-arrow-down-to-line" title="{{ __('Download Image') }}"></i></a>
						<img id="result" alt="">
					</div>
				</div>					
			</div>
