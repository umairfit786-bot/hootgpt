...
<script src="{{theme_url('js/results.js')}}"></script>
...
<script type="text/javascript">
	$(function () {
		...
		var table = $('#userResultTable').DataTable({
			...
			colReorder: true,
			language: {
				"emptyTable": "<div><img id='no-results-img' src='{{ theme_url('img/files/no-result.png') }}'><br>{{ __('No trascribe tasks created yet') }}</div>",
