									...
									@if (App\Services\HelperService::checkWordpressIntegrationFeature())
										<div class="btn-group mt-1 publish-action-buttons">
											...
											<div class="dropdown-menu" aria-labelledby="export" data-popper-placement="bottom-start">								
												<a class="dropdown-item" href="{{ route('user.integration.wordpress.post.create', $id) }}"><i class="fa-brands fa-wordpress fs-13 text-muted mr-2"></i> {{ __('Publish to Wordpress') }}</a>
											</div>
										</div>
									@endif
								@endif										
				...
				const menuItems = {
					...
					'rewrite': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Rewrite the following text in the same language as the text');
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden');
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'summarize': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Summarize below content professionally in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'improve': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Rewrite below content professionally in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'simplify': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Simplify the content below with basic words and make it clear in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'expand': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Make below content longer in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'trim': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Make below content shorter in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'fixgrammar': {
						...
						onAction: function () {
							...
							let formData = new FormData();
							formData.append( 'prompt', 'Fix grammatical mistakes in below content in the same language as the text' );
							formData.append( 'content', editor.selection.getContent() );
							document.querySelector('#loader-line')?.classList?.remove('hidden'); 
							$.ajax( {
								headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'tone': {
						...
						return [
							...
							onAction: function () {
									...
									let formData = new FormData();
									formData.append( 'prompt', 'Rewrite the content below in professional tone in the same language as the text' );
									formData.append( 'content', editor.selection.getContent() );
									document.querySelector('#loader-line')?.classList?.remove('hidden'); 
									$.ajax( {
										headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					...
					'style': {
						...
						return [
							...
							onAction: function () {
									...
									let formData = new FormData();
									formData.append( 'prompt', 'Rewrite the content below using business style of writing in the same language as the text' );
									formData.append( 'content', editor.selection.getContent() );
									document.querySelector('#loader-line')?.classList?.remove('hidden'); 
									$.ajax( {
										headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
