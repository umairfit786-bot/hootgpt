...
<script type="text/javascript">
	...
	$(function () {
					...
					'customwrite': {
						...
						onAction: function ( e ) {
							...
							$.ajax( {
								...
								type: "post",
								url: "/app/user/smart-editor/custom",
								data: formData,
								contentType: false,
								processData: false,
		...
		$('#openai-form').on('submit', function(e) {
			...
			$.ajax({
				headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
				method: 'POST',
				url: '/app/user/smart-editor/generate',
				data: form,
				beforeSend: function() {
				...
				success: function (data) {	
					...
					if (data['status'] == 'error') {
						...
						const eventSource = new EventSource( "/app/user/smart-editor/process?content_id=" + data.id+"&temperature=" + data.temperature + "&language=" + data.language);
	...
	function favoriteStatus() {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'post',
			url: '/app/user/smart-editor/favorite',
			data: formData,
			processData: false,
			contentType: false,
			success: function (data) {
	...
	function saveText(event) {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'POST',
			url: '/app/user/smart-editor/save',
	...
	$('.target-template').on('click', function () {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'POST',
			url: '/app/user/smart-editor/show',
