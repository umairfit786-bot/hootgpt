...
@section('content')
	...
	@foreach($activeAnnouncements as $announcement)
	 	<div id="pusher-notification">
			<div class="row mb-7" id="announcement-{{ $announcement->id }}">
				<div class="col-12">
					<div class="announcement-banner" style="background-color: {{ $announcement->background_color }}; border: 1px solid #dbe2eb; color: {{ $announcement->text_color }}; padding: 2rem 3rem; border-radius: 8px; display: flex; align-items: center; justify-content: space-between;">
						<div class="announcement-content">
							<h3 class="mb-4 font-weight-semibold fs-18" style="color: {{ $announcement->text_color }};">{{ $announcement->title }}</h3>
							<p class="mb-4 fs-14" style="color: {{ $announcement->text_color }};">{{ $announcement->text }}</p>
							@if(isset($announcement->url))
								<a href="{{ $announcement->url }}" class="btn btn-primary announcement-action-button mr-2">{{ __($announcement->button_name) }}</a>
							@endif
							<button type="button" class="btn btn-primary announcement-cancel-button" onclick="document.getElementById('announcement-{{ $announcement->id }}').style.display='none'">{{ __('Dismiss') }}</button>
						</div>
						<div class="announcement-image">
							@if($announcement->image)
								<img src="{{ URL::asset($announcement->image) }}" alt="" style="max-width: 200px; height: 100px; object-fit: cover; border-radius: 4px;">
							@endif
			...
			<div class="card"  style="height: 100%;">
				...
				<div class="card-body pt-2" style="height: 100%; max-height: 300px; overflow-y: scroll;">
					<div class="row">
						...
						@endif
						@if (App\Services\HelperService::checkChatAccess())
							<div class="col-md-6 col-sm-12">												
						...
						@endif	
						@if (App\Services\HelperService::checkAIArticleWizardAccess())				
							<div class="col-md-6 col-sm-12">												
						...
						@endif
						@if (App\Services\HelperService::checkAIWriterAccess())
							<div class="col-md-6 col-sm-12">												
						...
						@endif
						@if (App\Services\HelperService::checkSmartEditorAccess())
							<div class="col-md-6 col-sm-12">												
	...
	@if (App\Services\HelperService::checkAIImagesAccess())
		<div class="row mt-5">
			<div class="col-lg col-md-12 col-sm-12">
...
@section('js')
	...
	@if (config('broadcasting.default') == 'pusher')
		@if (!is_null(config('broadcasting.connections.pusher.key')))
