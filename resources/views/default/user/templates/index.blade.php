								...
								@foreach ($categories as $category)					
									...
									@foreach ($favorite_templates as $template)
										@if ($template->group == $category->code)
											<div class="col-lg-3 col-md-6 col-sm-12 pl-1 pr-1 template-item-wrapper">
												<div class="template">
													<a id="{{ $template->template_code }}" onclick="favoriteStatus(this.id)"><i id="{{ $template->template_code }}-icon" class="@if($template->favorite) fa-solid fa-stars @else fa-regular fa-star @endif star"></i></a>
													<div class="card @if($template->package == 'professional') professional @elseif($template->package == 'premium') premium @elseif($template->favorite) favorite @else   @endif" id="{{ $template->template_code }}-card" onclick="window.location.href='{{ url('app/user/templates/original-template') }}/{{ $template->slug }}'">
														<div class="card-body pt-5">
															...
															<div class="template-category">
																<p class="fs-9 btn btn-category mb-0">{{ __($category->name) }}</p>
																<div class="template-package-info">
																	@if($template->package == 'professional') 
																		<p class="fs-8 btn btn-pro mb-0"><i class="fa-solid fa-crown mr-2"></i>{{ __('Pro') }}</p>
																		@if($template->new)
																			<p class="fs-8 btn btn-new mb-0 btn-new-pro"><i class="fa-solid fa-sparkles mr-2"></i>{{ __('New') }}</p>
																		@endif
																	@elseif($template->package == 'free')
																		<p class="fs-8 btn btn-free mb-0"><i class="fa-solid fa-gift mr-2"></i>{{ __('Free') }}</p>
																		@if($template->new)
																			<p class="fs-8 btn btn-new mb-0 btn-new-free"><i class="fa-solid fa-sparkles mr-2"></i>{{ __('New') }}</p>
																		@endif
																	@elseif($template->package == 'premium')
																		<p class="fs-8 btn btn-yellow mb-0"><i class="fa-solid fa-gem mr-2"></i>{{ __('Premium') }}</p>
																		@if($template->new)
																			<p class="fs-8 btn btn-new mb-0 btn-new-premium"><i class="fa-solid fa-sparkles mr-2"></i>{{ __('New') }}</p>
																		@endif
																	@elseif($template->new)
																		<p class="fs-8 btn btn-new mb-0"><i class="fa-solid fa-sparkles mr-2"></i>{{ __('New') }}</p>
																	@endif
																</div>
															</div>
														</div>
									...
									@foreach ($favorite_custom_templates as $template)
										@if ($template->group == $category->code)
											<div class="col-lg-3 col-md-6 col-sm-12 pl-1 pr-1 template-item-wrapper">
												<div class="template">
													<a id="{{ $template->template_code }}" onclick="favoriteStatusCustom(this.id)"><i id="{{ $template->template_code }}-icon" class="@if($template->favorite) fa-solid fa-stars @else fa-regular fa-star @endif star"></i></a>
