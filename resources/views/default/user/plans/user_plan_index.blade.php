						...
						<div class="col-lg-8 col-md-8 col-sm-12" style="margin-top: auto; margin-bottom: auto">
							<div class="row text-center">
								<div class="col-lg col-md-6 col-sm-6">									
									<h6 class="fs-12 mt-3 font-weight-bold">@if ($settings->model_credit_name == 'words') {{ __('Words Left') }} @else {{ __('Tokens Left') }} @endif</h6>	
			...
			<div class="card border-0 pt-2">
				<div class="card-body">		
					<div class="title text-center mt-5 mb-5 backend-title">
						<h3 class="mb-4 fs-25 super-strong">{{ __('Our Subscription Plans') }}</h3>     
