								...
								<div class="checkout-wrapper-box">
									...
									<div class="plan prepaid-plan">
										...
										<div class="credits-box">
											...
											@if ($id->images != 0) <p class="fs-12 mt-2 mb-0"><i class="fa-solid fa-check fs-14 mr-2 text-success"></i> {{ __('Images Included') }}: <span class="ml-2 font-weight-bold text-primary" style="float: right">{{ number_format($id->images) }}</span></p>@endif
									...
									<div class="input-box mb-5">
										<div class="text-center">								
											<input type="text" class="form-control mb-2" name="promo_code" placeholder="{{ __('Promocode') }}">											
											<a class="btn btn-cancel ripple" id="prepaid-promocode-apply">{{ __('Apply Promocode') }}</a>																					
										</div>
