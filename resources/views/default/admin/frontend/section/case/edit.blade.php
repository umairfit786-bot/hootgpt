	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.settings.feature') }}"> {{ __('Use Cases Section') }}</a></li>
		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.settings.case.update', [$id->id]) }}" method="POST" enctype="multipart/form-data">
						@method('PUT')
						@csrf
						...
						<div class="row mt-2">	
							...
							<div class="col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="icon" name="icon" value="{{ $id->icon }}">
									</div> 
									@error('icon')
						...
						<div class="border-0 text-center mb-2 mt-1">
							<a href="{{ route('admin.settings.case') }}" class="btn btn-cancel mr-2 ripple pl-7 pr-7">{{ __('Return') }}</a>
