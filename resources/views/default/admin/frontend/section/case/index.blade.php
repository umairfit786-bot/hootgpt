...
@section('content')						
	<div class="row justify-content-center">
		<div class="col-lg-9 col-md-12 col-xm-12">
			<h3 class="card-title text-center mb-4">{{ __('Use Cases List') }}</h3>
			<div class="text-center mb-6">
				<a href="{{ route('admin.settings.case.create') }}" class="btn btn-primary ripple">{{ __('Create New Use Case') }}</a>
			</div>
			<div class="card">
