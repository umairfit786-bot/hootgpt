	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('New FAQ Answer') }}</a></li>
			</ol>
		</div>
				...
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.settings.faq.store') }}" method="post" enctype="multipart/form-data">
						...
						<div class="border-0 text-center mb-2 mt-1">
							<a href="{{ route('admin.settings.faq') }}" class="btn btn-cancel mr-2 pl-7 pr-7">{{ __('Return') }}</a>
