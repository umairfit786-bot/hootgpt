				...
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.settings.blog.update', [$id->id]) }}" method="POST" enctype="multipart/form-data">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6>{{ __('Blog Status') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
			  						<select id="smtp-encryption" name="status" class="form-select" data-placeholder="Blog Status:">			
						...
						<div class="border-0 text-center mb-2 mt-1">
							<a href="{{ route('admin.settings.blog') }}" class="btn btn-cancel mr-2 pl-7 pr-7">{{ __('Return') }}</a>
...
@section('js')
	<!-- File Uploader -->
	<script src="{{theme_url('js/file-upload.js')}}"></script>
	<!-- RichText JS -->
