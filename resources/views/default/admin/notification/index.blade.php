...
@section('content')						
	<div class="row justify-content-center">
		<div class="col-lg-12 col-md-12 col-xm-12">
			<h3 class="card-title text-center mb-4">{{ __('All User Notifications') }}</h3>
			<div class="text-center mb-6">
				<a href="{{ route('admin.notifications.create') }}" class="btn btn-primary">{{ __('New Notification') }}</a>
			</div>
			<div class="card">
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#allNotificationsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><img id='no-results-img' src='{{ theme_url('img/files/no-notification.png') }}'><br>{{ __('You have not created any mass notifications yet') }}</div>",
