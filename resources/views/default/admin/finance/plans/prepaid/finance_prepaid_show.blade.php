...
@section('content')						
	<div class="row justify-content-center">
		...
		<div class="col-lg-6 col-md-6 col-xm-12">
			<h3 class="card-title text-center">{{ __('Prepaid Plan Name') }}: <span class="text-info">{{ $id->plan_name }}</span> </h3>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
								...
								<span class="fs-14 font-weight-semibold">{{ number_format($id->tokens) }}</span>
							</div>	
						</div>	
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
								<h6 class="text-muted fs-12 mb-1">{{ __('Media Credits') }} </h6>
								<span class="fs-14 font-weight-semibold">{{ number_format($id->images) }}</span>
							</div>	
						</div>						
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
