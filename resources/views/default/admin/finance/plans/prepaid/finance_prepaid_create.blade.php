				...
				<div class="card-body pt-0">
					...
					<form action="{{ route('admin.finance.prepaid.store') }}" method="POST" enctype="multipart/form-data">
										...
										<div class="input-box">
											...
											<select id="currency" name="currency" class="form-select"
												...
												@foreach(config('currencies.all') as $key => $value)
													<option value="{{ $key }}"
														@if(config('payment.default_system_currency') == $key) selected @endif>
						...
						<div class="card mt-7">
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-5 plan-title-bar "><i
										class="fa-solid fa-box-circle-check text-info fs-14 mr-1 fw-2"></i>{{ __('Included Credits') }}
								</h6>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-12 col-sm-12">
										<div class="input-box">
											<h6>{{ __('Characters') }} <span class="text-required"><i
														class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">
									...
									<div class="col-lg-6 col-md-12 col-sm-12">
										<div class="input-box">
											<h6>{{ __('Minutes') }} <span class="text-required"><i
														class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">
										...
										<div class="input-box">
											...
											<div class="form-group">
												<input type="number" class="form-control" id="voice_clones"
													name="voice_clones" value="0" required>
												<span
