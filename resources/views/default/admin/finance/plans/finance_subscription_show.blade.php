			...
			<div class="card border-0">
				<div class="card-body pt-5">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
								<h6 class="text-muted fs-12 mb-1">@if ($settings->model_credit_name == 'words'){{ __('Word Credits') }} @else {{ __('Token Credits') }}@endif </h6>
								<span class="fs-14 font-weight-semibold">@if ($id->token_credits == -1) {{ __('Unlimited') }} @else {{ number_format($id->token_credits) }} @endif</span>
							</div>	
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
								<h6 class="text-muted fs-12 mb-1">{{ __('Media Credits') }} </h6>
								<span class="fs-14 font-weight-semibold">@if ($id->image_credits == -1) {{ __('Unlimited') }} @else {{ number_format($id->image_credits) }} @endif</span>
							</div>	
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<div class="prepaid-view-box text-center">
