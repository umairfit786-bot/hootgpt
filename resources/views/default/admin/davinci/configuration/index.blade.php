					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
							<form id="general-features-form" action="{{ route('admin.davinci.configs.store') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="row">							
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">	
											...
											<select id="default-model-admin" name="default-model-admin" class="form-select" data-placeholder="{{ __('Select Default Model') }}:">			
												...
												<option value="gpt-5" @if ( config('settings.default_model_admin')  == 'gpt-5') selected @endif>{{ __('GPT 5') }}</option>														
												<option value="gpt-5-mini" @if ( config('settings.default_model_admin')  == 'gpt-5-mini') selected @endif>{{ __('GPT 5 mini') }}</option>														
												<option value="gpt-5-nano" @if ( config('settings.default_model_admin')  == 'gpt-5-nano') selected @endif>{{ __('GPT 5 nano') }}</option>														
												<option value="gpt-5-chat-latest" @if ( config('settings.default_model_admin')  == 'gpt-5-chat-latest') selected @endif>{{ __('GPT 5 chat') }}</option>
												<option value="gpt-5.2" @if ( config('settings.default_model_admin')  == 'gpt-5.2') selected @endif>{{ __('GPT 5.2') }}</option>
												<option value="gpt-5.2-pro" @if ( config('settings.default_model_admin')  == 'gpt-5.2-pro') selected @endif>{{ __('GPT 5.2 Pro') }}</option>
												<option value="claude-sonnet-4-6" @if ( config('settings.default_model_admin')  == 'claude-sonnet-4-6') selected @endif>{{ __('Claude 4.6 Sonnet') }}</option>
												<option value="claude-sonnet-4-5" @if ( config('settings.default_model_admin')  == 'claude-sonnet-4-5') selected @endif>{{ __('Claude 4.5 Sonnet') }}</option>
												<option value="claude-haiku-4-5" @if ( config('settings.default_model_admin')  == 'claude-haiku-4-5') selected @endif>{{ __('Claude 4.5 Haiku') }}</option>
												<option value="claude-opus-4-6" @if ( config('settings.default_model_admin')  == 'claude-opus-4-6') selected @endif>{{ __('Claude 4.6 Opus') }}</option>
												<option value="claude-opus-4-1-20250805" @if ( config('settings.default_model_admin')  == 'claude-opus-4-1-20250805') selected @endif>{{ __('Claude 4.1 Opus') }}</option>
												...
												<option value="gemini-2.5-flash-lite" @if ( config('settings.default_model_admin')  == 'gemini-2.5-flash-lite') selected @endif>{{ __('Gemini 2.5 Flash Lite') }}</option>
												<option value="gemini-3-flash-preview" @if ( config('settings.default_model_admin')  == 'gemini-3-flash-preview') selected @endif>{{ __('Gemini 3 Flash') }}</option>
												<option value="gemini-3-pro-preview" @if ( config('settings.default_model_admin')  == 'gemini-3-pro-preview') selected @endif>{{ __('Gemini 3 Pro') }}</option>
												...
												<option value="grok-4-latest" @if ( config('settings.default_model_admin')  == 'grok-4-latest') selected @endif>{{ __('Grok 4') }}</option>
												...
												@if (App\Services\HelperService::extensionAmazonBedrock())	
													...
													<option value="us.amazon.nova-2-omni-v1:0" @if ( config('settings.default_model_admin')  == 'us.amazon.nova-2-omni-v1:0') selected @endif>{{ __('Nova 2 Omni') }}</option>
													<option value="us.amazon.nova-2-lite-v1:0" @if ( config('settings.default_model_admin')  == 'us.amazon.nova-2-lite-v1:0') selected @endif>{{ __('Nova 2 Lite') }}</option>
													<option value="us.amazon.nova-2-pro-v1:0" @if ( config('settings.default_model_admin')  == 'us.amazon.nova-2-pro-v1:0') selected @endif>{{ __('Nova 2 Pro') }}</option>
												@endif
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6>{{ __('Templates Package Access') }} <span class="text-muted">({{ __('For Admin Group') }})</span> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									...
									<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/api/google')}}'">
										<div class="card-body p-5 d-flex">
											...
											<div class="extension-title">
												...
												<p class="fs-12 mb-0 text-muted">{{ __('AI Voiceover | AI Writer | AI Chat | Cloud Storage')}}</p>
											</div>
										</div>							
									</div>
								</div>
									...
									<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/api/aws')}}'">
										<div class="card-body p-5 d-flex">
											...
											<div class="extension-title">
												...
												<p class="fs-12 mb-0 text-muted">{{ __('AI Voiceover | Cloud Storage')}}</p>
											</div>
										</div>							
									</div>
								</div>
						...
						<div class="tab-pane fade" id="extended" role="tabpanel" aria-labelledby="extended-tab">
							...
							<div class="row">
								...
								@if (App\Services\HelperService::extensionOnboardingPro())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/onboarding-pro')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class="fa-solid fa-arrow-progress mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
								...
								@if (App\Services\HelperService::extensionLiveAnnouncement())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/live-announcement')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class="fa-solid fa-bullhorn mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('Live Announcement') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Pusher API keys and service configurations')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionTelegramBot())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/telegram-bot')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<img src="{{theme_url('img/csp/telegram.webp')}}" class="mr-4" alt="" style="width: 40px;">											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('Telegram') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Telegram service configurations')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionWhatsappBot())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/whatsapp-bot')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<img src="{{theme_url('img/csp/whatsapp.webp')}}" class="mr-4" alt="" style="width: 40px;">											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('Whatsapp') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Whatsapp service configurations')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionLemonfoxTextToSpeech())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/lemonfox-text')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<img src="{{theme_url('img/csp/lemonfox.webp')}}" class="mr-4" alt="" style="width: 40px;">												
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('Lemonfox Text to Speech') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Lemonfox API keys and service configurations')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionExternalChatbotAnalytics())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/external-analytics')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class=" fa-solid fa-chart-mixed mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('AI External Chatbot Analytics') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('External Chatbot Analytics settings and configuration')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionNanoBanana())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/nano-banana')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<img src="{{theme_url('img/csp/gcp-sm.png')}}" class="mr-4" alt="" style="width: 40px;">												
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('Nano Banana') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Gemini API keys and service configurations')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionVoiceChatbot())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/voice-chatbot')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class=" fa-solid fa-headset mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('AI Voice Chatbot') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Voice Chatbot settings and configuration')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionChatPro())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/chat-pro')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class=" fa-solid fa-message-lines mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('AI Chat Pro') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Chat Pro settings and configuration')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								@if (App\Services\HelperService::extensionHumanAgent())
									<div class="col-md-6 col-sm-12">
										<div class="card shadow-0 mb-6" onclick="window.location.href='{{ url('/app/admin/davinci/configs/human-agent')}}'">
											<div class="card-body p-5 d-flex">
												<div class="extension-icon">
													<i class=" fa-solid fa-user-headset mr-4" style="font-size: 40px!important;"></i>											
												</div>
												<div class="extension-title">
													<div class="d-flex">
														<h6 class="fs-15 font-weight-bold mb-3">{{ __('AI External Chatbot Human Agent') }}</h6>
													</div>
													<p class="fs-12 mb-0 text-muted">{{ __('Human Agent settings and configuration')}}</p>
												</div>
											</div>							
										</div>
									</div>
								...
								<div class="card shadow-0 mb-7">							
									<div class="card-body">
										...
										<div class="row">			
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">
													<h6>{{ __('Templates Package Access') }} <span class="text-muted">({{ __('For Non-Subscribers') }})</span> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">	
													...
													<select id="default-model-user-bot" name="default-model-user-bot" class="form-select">			
														...
														<option value="gpt-5" @if ( config('settings.default_model_user_bot')  == 'gpt-5') selected @endif>{{ __('GPT 5') }}</option>														
														<option value="gpt-5-mini" @if ( config('settings.default_model_user_bot')  == 'gpt-5-mini') selected @endif>{{ __('GPT 5 mini') }}</option>														
														<option value="gpt-5-nano" @if ( config('settings.default_model_user_bot')  == 'gpt-5-nano') selected @endif>{{ __('GPT 5 nano') }}</option>														
														<option value="gpt-5-chat-latest" @if ( config('settings.default_model_user_bot')  == 'gpt-5-chat-latest') selected @endif>{{ __('GPT 5 chat') }}</option>	
														<option value="gpt-5.2" @if ( config('settings.default_model_user_bot')  == 'gpt-5.2') selected @endif>{{ __('GPT 5.2') }}</option>	
														<option value="gpt-5.2-pro" @if ( config('settings.default_model_user_bot')  == 'gpt-5.2-pro') selected @endif>{{ __('GPT 5.2 Pro') }}</option>	
														<option value="claude-sonnet-4-6" @if ( config('settings.default_model_user_bot')  == 'claude-sonnet-4-6') selected @endif>{{ __('Claude 4.6 Sonnet') }}</option>													
														<option value="claude-sonnet-4-5" @if ( config('settings.default_model_user_bot')  == 'claude-sonnet-4-5') selected @endif>{{ __('Claude 4.5 Sonnet') }}</option>													
														<option value="claude-haiku-4-5" @if ( config('settings.default_model_user_bot')  == 'claude-haiku-4-5') selected @endif>{{ __('Claude 4.5 Haiku') }}</option>													
														<option value="claude-opus-4-6" @if ( config('settings.default_model_user_bot')  == 'claude-opus-4-6') selected @endif>{{ __('Claude 4.6 Opus') }}</option>
														<option value="claude-opus-4-1-20250805" @if ( config('settings.default_model_user_bot')  == 'claude-opus-4-1-20250805') selected @endif>{{ __('Claude 4.1 Opus') }}</option>
														...
														<option value="gemini-2.5-flash-lite" @if ( config('settings.default_model_user_bot')  == 'gemini-2.5-flash-lite') selected @endif>{{ __('Gemini 2.5 Flash Lite') }}</option>
														<option value="gemini-3-flash-preview" @if ( config('settings.default_model_user_bot')  == 'gemini-3-flash-preview') selected @endif>{{ __('Gemini 3 Flash') }}</option>
														<option value="gemini-3-pro-preview" @if ( config('settings.default_model_user_bot')  == 'gemini-3-pro-preview') selected @endif>{{ __('Gemini 3 Pro') }}</option>
														...
														<option value="grok-4-latest" @if ( config('settings.default_model_user_bot')  == 'grok-4-latest') selected @endif>{{ __('Grok 4') }}</option>
														...
														@if (App\Services\HelperService::extensionAmazonBedrock())	
															...
															<option value="us.amazon.nova-2-omni-v1:0" @if ( config('settings.default_model_user_bot')  == 'us.amazon.nova-2-omni-v1:0') selected @endif>{{ __('Nova 2 Omni') }}</option>
															<option value="us.amazon.nova-2-lite-v1:0" @if ( config('settings.default_model_user_bot')  == 'us.amazon.nova-2-lite-v1:0') selected @endif>{{ __('Nova 2 Lite') }}</option>
															<option value="us.amazon.nova-2-pro-v1:0" @if ( config('settings.default_model_user_bot')  == 'us.amazon.nova-2-pro-v1:0') selected @endif>{{ __('Nova 2 Pro') }}</option>
														@endif
														@foreach ($models as $model)
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">	
													...
													<select id="default-model-user-template" name="default-model-user-template" class="form-select">	
														...
														<option value="gpt-5" @if ( config('settings.default_model_user_template')  == 'gpt-5') selected @endif>{{ __('GPT 5') }}</option>														
														<option value="gpt-5-mini" @if ( config('settings.default_model_user_template')  == 'gpt-5-mini') selected @endif>{{ __('GPT 5 mini') }}</option>														
														<option value="gpt-5-nano" @if ( config('settings.default_model_user_template')  == 'gpt-5-nano') selected @endif>{{ __('GPT 5 nano') }}</option>														
														<option value="gpt-5-chat-latest" @if ( config('settings.default_model_user_template')  == 'gpt-5-chat-latest') selected @endif>{{ __('GPT 5 chat') }}</option>
														<option value="gpt-5.2" @if ( config('settings.default_model_user_template')  == 'gpt-5.2') selected @endif>{{ __('GPT 5.2') }}</option>
														<option value="gpt-5.2-pro" @if ( config('settings.default_model_user_template')  == 'gpt-5.2-pro') selected @endif>{{ __('GPT 5.2 Pro') }}</option>
														<option value="claude-sonnet-4-6" @if ( config('settings.default_model_user_template')  == 'claude-sonnet-4-6') selected @endif>{{ __('Claude 4.6 Sonnet') }}</option>													
														<option value="claude-sonnet-4-5" @if ( config('settings.default_model_user_template')  == 'claude-sonnet-4-5') selected @endif>{{ __('Claude 4.5 Sonnet') }}</option>													
														<option value="claude-haiku-4-5" @if ( config('settings.default_model_user_template')  == 'claude-haiku-4-5') selected @endif>{{ __('Claude 4.5 Haiku') }}</option>
														<option value="claude-opus-4-6" @if ( config('settings.default_model_user_template')  == 'claude-opus-4-6') selected @endif>{{ __('Claude 4.6 Opus') }}</option>
														<option value="claude-opus-4-1-20250805" @if ( config('settings.default_model_user_template')  == 'claude-opus-4-1-20250805') selected @endif>{{ __('Claude 4.1 Opus') }}</option>
														...
														<option value="gemini-2.5-flash-lite" @if ( config('settings.default_model_user_template')  == 'gemini-2.5-flash-lite') selected @endif>{{ __('Gemini 2.5 Flash Lite') }}</option>
														<option value="gemini-3-flash-preview" @if ( config('settings.default_model_user_template')  == 'gemini-3-flash-preview') selected @endif>{{ __('Gemini 3 Flash') }}</option>
														<option value="gemini-3-pro-preview" @if ( config('settings.default_model_user_template')  == 'gemini-3-pro-preview') selected @endif>{{ __('Gemini 3 Pro') }}</option>
														...
														<option value="grok-4-latest" @if ( config('settings.default_model_user_template')  == 'grok-4-latest') selected @endif>{{ __('Grok 4') }}</option>
														...
														@if (App\Services\HelperService::extensionAmazonBedrock())	
															...
															<option value="us.amazon.nova-2-omni-v1:0" @if ( config('settings.default_model_user_template')  == 'us.amazon.nova-2-omni-v1:0') selected @endif>{{ __('Nova 2 Omni') }}</option>
															<option value="us.amazon.nova-2-lite-v1:0" @if ( config('settings.default_model_user_template')  == 'us.amazon.nova-2-lite-v1:0') selected @endif>{{ __('Nova 2 Lite') }}</option>
															<option value="us.amazon.nova-2-pro-v1:0" @if ( config('settings.default_model_user_template')  == 'us.amazon.nova-2-pro-v1:0') selected @endif>{{ __('Nova 2 Pro') }}</option>
														@endif
														@foreach ($models as $model)
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">
													...
													<select class="form-select" id="models-list" name="models_list[]" multiple>
														...
														<option value="gpt-5" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5') selected @endif @endforeach>{{ __('GPT 5') }}</option>														
														<option value="gpt-5-mini" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5-mini') selected @endif @endforeach>{{ __('GPT 5 mini') }}</option>														
														<option value="gpt-5-nano" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5-nano') selected @endif @endforeach>{{ __('GPT 5 nano') }}</option>														
														<option value="gpt-5-chat-latest" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5-chat-latest') selected @endif @endforeach>{{ __('GPT 5 chat') }}</option>
														<option value="gpt-5.2" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5.2') selected @endif @endforeach>{{ __('GPT 5.2') }}</option>
														<option value="gpt-5.2-pro" @foreach ($all_models as $key=>$value) @if($value == 'gpt-5.2-pro') selected @endif @endforeach>{{ __('GPT 5.2 Pro') }}</option>
														<option value="claude-sonnet-4-6" @foreach ($all_models as $key=>$value) @if($value == 'claude-sonnet-4-6') selected @endif @endforeach>{{ __('Claude 4.6 Sonnet') }}</option>
														<option value="claude-sonnet-4-5" @foreach ($all_models as $key=>$value) @if($value == 'claude-sonnet-4-5') selected @endif @endforeach>{{ __('Claude 4.5 Sonnet') }}</option>
														<option value="claude-haiku-4-5" @foreach ($all_models as $key=>$value) @if($value == 'claude-haiku-4-5') selected @endif @endforeach>{{ __('Claude 4.5 Haiku') }}</option>
														<option value="claude-opus-4-6" @foreach ($all_models as $key=>$value) @if($value == 'claude-opus-4-6') selected @endif @endforeach>{{ __('Claude 4.6 Opus') }}</option>
														<option value="claude-opus-4-1-20250805" @foreach ($all_models as $key=>$value) @if($value == 'claude-opus-4-1-20250805') selected @endif @endforeach>{{ __('Claude 4.1 Opus') }}</option>
														...
														<option value="gemini-2.5-flash-lite" @foreach ($all_models as $key=>$value) @if($value == 'gemini-2.5-flash-lite') selected @endif @endforeach>{{ __('Gemini 2.5 Flash Lite') }}</option>
														<option value="gemini-3-flash-preview" @foreach ($all_models as $key=>$value) @if($value == 'gemini-3-flash-preview') selected @endif @endforeach>{{ __('Gemini 3 Flash') }}</option>
														<option value="gemini-3-pro-preview" @foreach ($all_models as $key=>$value) @if($value == 'gemini-3-pro-preview') selected @endif @endforeach>{{ __('Gemini 3 Pro') }}</option>
														...
														<option value="grok-4-latest" @foreach ($all_models as $key=>$value) @if($value == 'grok-4-latest') selected @endif @endforeach>{{ __('Grok 4') }}</option>
														...
														@if (App\Services\HelperService::extensionAmazonBedrock())	
															...
															<option value="us.amazon.nova-2-omni-v1:0" @foreach ($all_models as $key=>$value) @if($value == 'us.amazon.nova-2-omni-v1:0') selected @endif @endforeach>{{ __('Nova 2 Omni') }}</option>
															<option value="us.amazon.nova-2-lite-v1:0" @foreach ($all_models as $key=>$value) @if($value == 'us.amazon.nova-2-lite-v1:0') selected @endif @endforeach>{{ __('Nova 2 Lite') }}</option>
															<option value="us.amazon.nova-2-pro-v1:0" @foreach ($all_models as $key=>$value) @if($value == 'us.amazon.nova-2-pro-v1:0') selected @endif @endforeach>{{ __('Nova 2 Pro') }}</option>
														@endif
