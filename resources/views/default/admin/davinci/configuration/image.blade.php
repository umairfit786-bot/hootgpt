				...
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.davinci.configs.image.credits.store') }}" method="post" enctype="multipart/form-data">
						...
						<div class="row pl-5 pr-5">							
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('OpenAI GPT Image') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
										<input type="number" min=1 class="form-control" name="gpt_image_1" value="{{ $credits->gpt_image_1 }}">
									</div> 	
								</div> 						
							</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('OpenAI GPT Image Mini') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
										<input type="number" min=1 class="form-control" name="gpt_image_1_mini" value="{{ $credits->gpt_image_1_mini }}">
									</div> 	
								</div> 						
							</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('OpenAI GPT Image 1.5') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
										<input type="number" min=1 class="form-control" name="gpt_image_1_5" value="{{ $credits->gpt_image_1_5 }}">
									</div> 	
								</div> 						
							</div>
						</div>
						...
						@if (App\Services\HelperService::extensionNanoBanana())
							<h6 class="text-muted text-center">{{ __('Google') }}</h6>

							<div class="row pl-5 pr-5">							

								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6>{{ __('Nano Banana') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="google_nano_banana" value="{{ $credits->google_nano_banana }}">
										</div> 	
									</div> 						
								</div>		
								...
								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6>{{ __('Nano Banana Pro') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="google_nano_banana_pro" value="{{ $credits->google_nano_banana_pro }}">
										</div> 	
									</div> 						
								</div>	
							</div>
