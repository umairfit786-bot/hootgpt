...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Software as a Service') }}</h4>
		...
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-body pt-7 pl-7 pr-7 pb-6">									
					<form action="{{ route('admin.davinci.configs.saas.store') }}" method="post" enctype="multipart/form-data">
						@csrf
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box mb-0">
											<h6>{{ __('Enable/Disable SaaS Feature') }}</h6>
											<div class="form-group mt-3">
												<label class="custom-switch">
													<input type="checkbox" name="saas_feature" class="custom-switch-input" @if ($extension->saas_feature) checked @endif>
