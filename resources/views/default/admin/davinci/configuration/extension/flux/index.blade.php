...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Fal AI') }}</h4>
		...
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-body pt-7 pl-7 pr-7 pb-6">									
					<form action="{{ route('admin.davinci.configs.flux.store') }}" method="post" enctype="multipart/form-data">
						@csrf
										...
										<div class="col-sm-12">
											<div class="input-box mb-3">								
												...
												<div class="form-group">							    
													<input type="text" class="form-control @error('flux_api') is-danger @enderror" id="flux_api" name="flux_api" value="{{ $extension->flux_api }}" autocomplete="off">
													@error('flux_api')
														<p class="text-danger">{{ $errors->first('flux_api') }}</p>
													@enderror
												</div> 												
											</div> 
										</div>
