...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('AI Photo Studio Feature Credits') }}</h4>
		...
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Set AI Photo Studio Feature Credits per Task') }}</h3>
				</div>
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.davinci.configs.photo.studio.credits.store') }}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<div class="row mt-2 pl-5 pr-5">							
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><span><i class='fa-solid fa-palette text-muted mr-2'></i></span>{{ __('Same Style Image') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
										<input type="number" min=1 class="form-control" name="style" value="{{ $studio->sd_photo_studio_style }}">
									</div> 	
								</div> 						
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12">							
