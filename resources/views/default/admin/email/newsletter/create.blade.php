...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center"> 
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Create New Email') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Create Email') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-6 col-md-10 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body pt-5">									
					<form action="{{ route('admin.email.newsletter.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									...
									<textarea class="form-control" name="footer" id="footer" rows="5"></textarea>
									@error('footer')
