...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center"> 
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Edit Email Template') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{route('admin.email.templates')}}"> {{ __('Email Templates') }}</a></li>
		...
		<div class="col-lg-6 col-md-10 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body pt-5">									
					<form action="{{ route('admin.email.templates.update', $id) }}" method="POST" enctype="multipart/form-data">
						@method('PUT')
						@csrf

						<h3 class="card-title text-center mb-6">{{ __('Edit Email Template') }}: <span class="font-weight-bold text-primary">{{ $id->name }}</span></h3>
						...
						<div class="border-0 text-center mb-2 mt-1">
							<a href="{{ route('admin.email.templates') }}" class="btn btn-cancel ripple mr-2 pl-7 pr-7">{{ __('Return') }}</a>
