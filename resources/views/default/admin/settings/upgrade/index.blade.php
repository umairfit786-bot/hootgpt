									...
									@if ($latest_version['status'])
											...
											<div id="audio-format" role="radiogroup">
												<span  id="webm-format">							
													<div class="radio-control">
														...
														<label for="concent" class="label-control text-muted fs-13" id="concent-label">{{  __('I confirm that I have read the Update tab in the documentation and will follow all steps there to finish the update') }} - <a class="font-weight-bold text-primary" target="_blank" href="https://davinci.mintlify.app/update/instructions">{{ __('Documentation Link') }}</a></label>
													</div>	
												</span>										
											</div>	
										</div>
										<div id="installed-info">
											<div class="text-center">
												...
												<h6 class="text-danger fs-14 font-weight-bold mt-4">{{ __('Warning! To complete the update process follow all steps listed under') }} <a class="font-weight-bold text-primary" target="_blank" href="https://davinci.mintlify.app/update/instructions">update instructions </a> {{ __('in the docs') }}</h6>
											</div>
										</div>														
									@else
										<div class="text-center">
			...
			<div class="changelogs">
				...
				<div class="changelog">
					...
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 9.2</span> - <span class="fs-14 font-weight-semibold">03.03.2026</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Veo 3.1 model added</span></li>
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Veo 3.1 Fast model added</span></li>
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Kling 3.0 Pro model added</span></li>
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Kling O3 model added</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Text to Video extension updated (v1.9)</span></li>															
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Image to Video extension updated (v1.7)</span></li>															
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Marketplace improvements</span></li>															
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Voice Isolator extension balance issue fixed (v1.2)</span></li>																												
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">User deletion minor issue fixed</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Login/Registration page metadata info improved</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">AI Vision issue fixed</span></li>
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					...
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 9.1</span> - <span class="fs-14 font-weight-semibold">01.03.2026</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Voice Chatbot v2 extension (Paid)</span></li>
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Human Agent v2 extension (Paid)</span></li>																
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Claude Opus 4.6 model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Claude Sonnet 4.6 model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Amazon Nova 2 Omni model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Amazon Nova 2 Pro model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Amazon Nova 2 Lite model added</span></li>										
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v3.4)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Amazon Bedrock extension updated (v1.2)</span></li>															
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Wallet credit assignment minor issue fixed</span></li>															
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Team member view minor fixed</span></li>															
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					...
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 9.0</span> - <span class="fs-14 font-weight-semibold">27.12.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5.2 model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5.2 Pro model added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT Image 1.5 added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT Image 1 mini added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Google Gemini 3 Flash model added</span></li>										
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Music extension updated (v1.4)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Midjourney extension updated (v1.2)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v3.3)</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">AI Images minor issue fixed</span></li>								
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Subscription details during registration improved</span></li>								
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Mobile responsiveness improved</span></li>								
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					...
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.9</span> - <span class="fs-14 font-weight-semibold">13.11.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">AI Chat Pro extension added (Paid)</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">External Chatbot Personal API keys feature added</span></li>										
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Knowledge Base for External Chatbots extension added (Free)</span></li>										
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">External Chatbot updated (v1.6)</span></li>									
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">External Chatbot support for latest OpenAI, Gemini, Anthropic models added</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">External Chatbot Channels visibility control improved</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Marketplace search option added</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Gemini all deprecated models removed</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">External Chatbot css style issue fixed</span></li>								
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.8</span> - <span class="fs-14 font-weight-semibold">26.11.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Google Gemini 3 Pro added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">NanoBanana Pro added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5.1 added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">xAI Grok 4.1 Fast added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Opus 4.5 added</span></li>									
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Midjourney extension updated (v1.1)</span></li>									
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Music extension updated (v1.3)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Awdpay payment gateway updated (v1.1)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v3.2)</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Manual credit assignment improved</span></li>																				
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">User default image model setting improved</span></li>																				
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					...
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.7</span> - <span class="fs-14 font-weight-semibold">27.10.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">AWDpay payment gateway extension (Free)</span></li>										
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v3.1)</span></li>									
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.6</span> - <span class="fs-14 font-weight-semibold">23.10.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Claude Sonnet 4.5 model added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Claude Haiku 4.5 model added</span></li>	
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Sora 2 model added (Text to Video extension)</span></li>	
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Sora 2 Pro model added (Text to Video extension)</span></li>	
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v3.0)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">User Dashboard feature enabled/disabled match updated</span></li>																																																																																																						
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.5</span> - <span class="fs-14 font-weight-semibold">16.10.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Google Nano Banana extension (Free)</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">GPT Image 1 model added</span></li>																																																																																														
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.4</span> - <span class="fs-14 font-weight-semibold">12.10.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">AI Voice Bots extension (Paid)</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">AI Writer template category access granularity for subscribers added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">AI Chat template category access granularity for subscribers added</span></li>									
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v2.9)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Sonic theme updated</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Classic theme updated</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Payment Gateways checkoug billing info recording fixed</span></li>																																																																																					
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Gift card redeem issue fixed</span></li>																																											
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">AI Voiceover minor issue fixed</span></li>																																																																																						
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.3.1</span> - <span class="fs-14 font-weight-semibold">15.09.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     													
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">External Chatbot minor bug fix</span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Elevenlabs minor bug fix</span></li>
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.3</span> - <span class="fs-14 font-weight-semibold">07.09.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Human Agent Chatbot extension added (Paid)</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Lemonfox Text to Speech extension added (Free)</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Update: Speechify Clone updated (v1.1)</span></li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v2.8)</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Code updated to support latest openai models</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI File Chat updated to support latest openai models</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Web Chat updated to support latest openai models</span></li>	
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Article Wizard updated to support latest openai models</span></li>	
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Classic Theme updated</span></li>	
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Security improvements</span></li>	
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Search feature minor issue fixed</span></span></li>																					
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Smart Editor minor issue fixed</span></span></li>																					
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.2</span> - <span class="fs-14 font-weight-semibold">25.08.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Telegram extension for External Chatbot added (Paid)</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Whatsapp extension for External Chatbot added (Paid)</span></li>
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">External Chatbot Advanced Analytics extension added (Paid)</span></li>																					
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">External Chatbot updated (v1.3)</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Security improvements applied</span></li>																						
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v2.7)</span></li>																						
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.1.1</span> - <span class="fs-14 font-weight-semibold">18.08.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     													
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Speechify TTS issue fixed</span></span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Gift Card page issue fixed (SaaS Business extension v2.5)</span></span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Onboarding Pro list seeder issue fixed (Onboarding Pro v1.1)</span></span></li>
							<li><span class="version-fix mr-2">Fix</span> <span class="text-muted fs-13">Live notification extension issue fixed (v1.1)</span></span></li>
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.1</span> - <span class="fs-14 font-weight-semibold">14.08.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Anthropic Opus 4.1 model added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">xAI Grok 4 model added</span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Stable Diffusion 3.5 Flash model added</span></li>										
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Product Photo Fashion feature deprecated (v1.4)</span></li>														
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">AI Speech To Text Pro Live Transcribe improved (v1.2)</span></li>								
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">Onboarding Pro updated (v1.1)</span></li>								
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 8.0</span> - <span class="fs-14 font-weight-semibold">10.08.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5 model added</span></span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5 mini model added</span></span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5 nano model added</span></span></li>									
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">OpenAI GPT 5 chat model added</span></span></li>	
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13">SaaS Business extension updated (v2.4)</span></li>								
						</ul>
					</div>
				</div>
				...
				<div class="changelog">
					<div class="changelog-version mt-5">
						<span class="version-name">{{ __('Version') }} 7.9</span> - <span class="fs-14 font-weight-semibold">09.08.2025</span>
					</div>   
					<div class="changelog-description mt-6">     
						<ul>	 	 				     
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Onboarding Pro extension (Paid)</span></span></li>					
							<li><span class="version-new mr-2">New</span> <span class="text-muted fs-13">Live Announcements extension (Free)</span></span></li>					
						</ul>
					</div>
				</div>
