						...
						<div class="row">
							...
							<div class="col-sm-12">								
								<div class="text-center mb-7">
									<div class="mb-7">
										<img src="{{ theme_url('img/files/lock.webp') }}" alt="" style="width:200px">
									</div>
									...
									<h3 class="card-title fs-12 mt-6 font-weight-bold text-muted">{{__('License Type') }}: <span class="text-primary font-weight-bold" style="padding: 0.2rem 1.5rem; margin-left: 0.5rem; border-radius: 1rem; background:#e1f0ff; ">{{ $type }}</span></h3>
								</div>
							</div>
				...
				Swal.fire({
					...
					if (result.isConfirmed) {
						...
						$.ajax({
							...
							method: 'post',
							url: '/app/admin/settings/activation/destroy',
							data: formData,
							processData: false,
							contentType: false,
