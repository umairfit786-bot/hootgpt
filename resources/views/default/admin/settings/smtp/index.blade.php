			...
			<div class="card border-0">
				<div class="card-body">
					...
					<form action="{{ route('admin.settings.smtp.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="border-0 mb-2 mt-1 text-center">
							<button href="#" type="button" class="btn btn-cancel mr-2 pl-7 pr-7" data-bs-toggle="modal" data-bs-target="#test-email">{{ __('Test') }}</button>
